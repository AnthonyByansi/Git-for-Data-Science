...
To perform a rebase, you first need to switch to the branch that you want to apply the changes to. Then, use the git rebase command followed by the name of the branch that contains the changes you want to apply.
